...
contract Pool1 is Initializable, ERC777Upgradeable, IERC721ReceiverUpgradeable {
    ...
    *   @param initName Name of this particular ERC777 token
    *   @param initSymbol The ticker this token will go by
    */
    function initialize(string memory initName, string memory initSymbol, address _ERCAddress, address _servicer, address approvedServicer) public initializer {
        //emptied initialize func to reduce space in deployment
    }
    ...
    *   @param loanId is the id for the loan we're looking up
    *   TODO:EDITED in pool1 to also return PropToken ID
    */
    ...
    */
    function borrow(uint256 amount, uint256 maxRate, uint256 propTokenId) public {
        ...
        require(PropToken0(propTokenContractAddress).getApproved(propTokenId) == address(this), "pool is not approved to move propToken");
        //also require msg.sender is owner of token
        require(PropToken0(propTokenContractAddress).ownerOf(propTokenId) == msg.sender, "msg.sender is not propToken owner");
        ...
        require(PropToken0(propTokenContractAddress).getLienValue(propTokenId) >= amount, "Loan amount too large for propToken value");
    ...
    */
    ...
    //todo: return the proptoken when fully repaid
