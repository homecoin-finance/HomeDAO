// contracts/Pool5.sol
// updated from Pool4  to split origination fee between servicer and guardian
...
contract Pool5 is Initializable, ERC777Upgradeable, IERC721ReceiverUpgradeable {
    ...
    /* Pool 5 variables introduced here */
    address daoAddress;
    ...
    ******************************************************/
    ...
    function initializePoolFive(address _daoAddress) public {
    ...
    */
    function borrow(uint256 amount, uint256 maxRate, uint256 propTokenId) public {
        ...
        mintProportionalPoolTokens(servicer, amount.div(200));
        //and mint HC_Pool for the DAO
        mintProportionalPoolTokens(daoAddress, amount.div(200));
    }
    ...
    */
    ...
    function repay(uint256 loanId, uint256 amount) public {        
        ...
        //in Pool5 fee is split in two and divided between servicer and DAO
        uint256 servicerFeeInERC = servicerFeePercentage.mul(interestAmountRepayed).div(loans[loanId].interestRate).div(2);
        mintProportionalPoolTokens(servicer, servicerFeeInERC);
        mintProportionalPoolTokens(daoAddress, servicerFeeInERC);
    }
